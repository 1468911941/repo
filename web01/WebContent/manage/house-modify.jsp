...
<DL class=clearfix>
  <DT>我的房屋信息</DT>
  <DD class=past>房屋信息修改</DD></DL>
<DIV class=box>
<FORM id=add_action name=add.action enctype="multipart/form-data" action="manage-result.htm" method="post">
<DIV class=infos>
<TABLE class=field>
  <TBODY>
  <TR>
    <TD class=field>房屋名称：</TD>
    <TD><INPUT id=add_action_title class=text type=text name=houseName value="张三的大洋房"> </TD>
    <TD class=field>全额退款日：</TD>
    <TD><INPUT id=add_action_title class=text type=text name=drawbackDay value="12"> </TD>
  </TR>
  <TR>
    <TD class=field>发票：</TD>
   
    <td><input class="radio" type="radio" name="receipt" value="1"  />提供
						
		<input class="radio" type="radio" name="receipt" value="0" checked="checked"/>不提供
		<span></span>
	</td>
      <TD class=field>日租价：</TD>
    <TD><INPUT id=add_action_title class=text type=text name=price value="300.0">元/天</TD>
     </TR>
  <TR>
  
    <TD class=field>出租类型：</TD>
    <TD><input class="radio" type="radio" name="rentType" value="0" checked="checked"/>整租
		<input class="radio" type="radio" name="rentType" value="1" />单间				
		<input class="radio" type="radio" name="rentType" value="2" />床位
		<span></span></TD>
    ...
    <TD><select name="houseType">
								...
								<option value="4" selected="selected">大洋房</option>
  ...
  <TR>
    ...
    <TD><select name="bedType">
								...
								<option value="1" selected="selected">双人床</option>
								
							</select> </TD>
</TR>
<TR>
   <TD class=field>房屋描述：</TD>
    <TD><TEXTAREA name=description >空调，电脑，电视</TEXTAREA> </TD>
  ...
  <TR>
   <TD class=field>设施服务：</TD>
    ...
    <TD><TEXTAREA name=address>一路</TEXTAREA></TD>
  ...
  <TR>
    ...
    <TD><INPUT id=add_action_title class=text type=text name=leastDays value="10"></TD>
     <TD class=field>最大天数：</TD>
    <TD><INPUT id=add_action_title class=text type=text name=mostDays value="18"> </TD>
  </TR>
  <TR>
    <TD class=field>房屋图片：<br></TD>
	<td><input type="file" class="text" name="image1" /><span></span></td>
    <TD class=field>面积：</TD>
    <TD><INPUT class=text type=text name=area value="250.0">平方米</TD>
  </TR>
  
  <tr>
  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
  <td><input type="file" class="text" name="image2" /><span></span></td>
  </tr>
  
  <tr>
  
   <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
   <td><input type="file" class="text" name="image3" /><span></span></td>
  </tr>
