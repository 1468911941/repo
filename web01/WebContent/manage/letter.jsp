		...
		<div class="guestbook">
			...
			<div id="content" >
				<form id="content" >
					<table width="512px" >
						<tr  >
							<td ><textarea name="receiveContent" readonly="readonly"
									id="receiveContent" cols="80" rows="12" ></textarea>
							<!--使滚动条默认在底部  -->
							<script>
							...
							<script>
								document.getElementById("receiveContent").value += "李四"+"  "+"2016-08-06"+"\r\n"+"你好，请问您的大洋房是在什么位置？"+"\r\n\r\n";
							</script>
									...
									<script>
								document.getElementById("receiveContent").value += "张三"+"  "+"2016-08-06"+"\r\n"+"在一路哦，亲~"+"\r\n\r\n";
							</script>
			...
			<div id="reply-box">
				<form id="guestBook" action="#" method="post">
					<table>
						<tr>
